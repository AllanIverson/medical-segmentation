...
class GlobalConfig():
    ...
    oasis_train_root_dir = '/data/zhanghao/skull_project/oasis_data_224/train_3D_224'
    oasis_valid_root_dir = '/data/zhanghao/skull_project/oasis_data_224/valid_3D_224'
    oasis_test_root_dir = '/data/zhanghao/skull_project/oasis_data_224/test_3D_224'
...
class Oasis_cc359_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image = image.reshape(1,160,224,224)
        mask = mask.reshape(1,160,224,224)
