...
class MAE3D(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=1, num_frames=160, temp_stride=2,
...
def mae3d_vit_base1024_patch16_dec512d4b(**kwargs):
    model = MAE3D(
...
def mae3d_vit_base1280_patch16_dec512d4b(**kwargs):
    model = MAE3D(
        patch_size=16, embed_dim=1280, depth=12, num_heads=16,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def mae3d_vit_base_patch16_stride5_dec512d4b(**kwargs):
    model = MAE3D(
        temp_stride=5,patch_size=16, embed_dim=768, depth=12, num_heads=12,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def mae3d_vit_base1536_patch16_dec512d4b(**kwargs):
    model = MAE3D(
        patch_size=16, embed_dim=1536, depth=12, num_heads=16,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def mae3d_vit_base1792_patch16_dec512d4b(**kwargs):
    model = MAE3D(
        patch_size=16, embed_dim=1792, depth=12, num_heads=16,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model

def mae3d_vit_base_patch16_stride1_dec512d4b(**kwargs):
    model = MAE3D(
        temp_stride=1,patch_size=16, embed_dim=1792, depth=12, num_heads=16,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model 
def mae3d_vit_base_patch16_stride2_dec512d4b(**kwargs):
    model = MAE3D(
        temp_stride=2,patch_size=16, embed_dim=1792, depth=12, num_heads=16,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model 
def mae3d_vit_base_patch16_stride16_dec512d4b(**kwargs):
    model = MAE3D(
        img_size=144,temp_stride=16,patch_size=16, embed_dim=768, depth=12, num_heads=12,
        decoder_embed_dim=512, decoder_depth=4, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model 

def mae3d_vit_base_patch8_stride8_dec512d4b(**kwargs):
    model = MAE3D(
        img_size=128,temp_stride=8,patch_size=8, embed_dim=768, depth=12, num_heads=8,
...
mae3d_vit_base1024_patch16 = mae3d_vit_base1024_patch16_dec512d4b  # decoder: 512 dim, 4 blocks
mae3d_vit_base1280_patch16 = mae3d_vit_base1280_patch16_dec512d4b  # decoder: 512 dim, 4 blocks
mae3d_vit_stride5_patch16 = mae3d_vit_base_patch16_stride5_dec512d4b 
mae3d_vit_base1536_patch16 = mae3d_vit_base1536_patch16_dec512d4b
mae3d_vit_base1792_patch16 = mae3d_vit_base1792_patch16_dec512d4b
mae3d_vit_stride1_patch16 = mae3d_vit_base_patch16_stride1_dec512d4b 
mae3d_vit_stride2_patch16 = mae3d_vit_base_patch16_stride2_dec512d4b 
mae3d_vit_144_stride16_patch16 = mae3d_vit_base_patch16_stride16_dec512d4b 
mae3d_vit_base_stride8_patch8 = mae3d_vit_base_patch8_stride8_dec512d4b