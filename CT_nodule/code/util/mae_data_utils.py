...
def get_loader(args):
    ...
    pretrain_train_transforms = transforms.Compose(
        [
            transforms.LoadImaged(keys=["image"],reader='ITKReader'),
    ...
    if True:
        ...
        '''
        脑部MRI训练集,混合数据集, ADNI OASIS (颅骨 有/无)
        '''
        adni_w = '/data2/zhanghao/Pretrain/utils/train/adni_wtrain.txt'
        adni_wo = '/data2/zhanghao/Pretrain/utils/train/adni_wotrain.txt'
        oasis_w = '/data2/zhanghao/Pretrain/utils/train/oasis_wtrain.txt'
        oasis_wo = '/data2/zhanghao/Pretrain/utils/train/oasis_wotrain.txt'
        oasis_skull = '/data2/zhanghao/Pretrain/utils/train/oasis_skulltrain.txt'
        cc359 = '/data2/zhanghao/Pretrain/utils/train/cc359train.txt'
        files = [adni_w,adni_wo,oasis_w,oasis_wo,cc359]
        pretrian_list = []
        ...
        train_list = pretrian_list
        print('len pretrian :',len(train_list))

        '''
        脑部MRI验证集,混合数据集, ADNI OASIS (颅骨 有/无)
        '''
        adni_w_v = '/data2/zhanghao/Pretrain/utils/val/adni_wval.txt'
        adni_wo_v = '/data2/zhanghao/Pretrain/utils/val/adni_woval.txt'
        oasis_w_v = '/data2/zhanghao/Pretrain/utils/val/oasis_wval.txt'
        oasis_wo_v = '/data2/zhanghao/Pretrain/utils/val/oasis_woval.txt'
        oasis_skull_v = '/data2/zhanghao/Pretrain/utils/val/oasis_skullval.txt'
        cc359_v = '/data2/zhanghao/Pretrain/utils/val/cc359val.txt'
        files_v = [adni_w_v,adni_wo_v,oasis_w_v,oasis_wo_v,cc359_v]
        pretrian_list = []
        ...
        for file in files_v:
            ...
            for i in list:
                dict = {"image": i}
                pretrian_list.append(dict)
        valid_list = pretrian_list
        print('len pretrian valid :',len(valid_list))
        ...
        if args.use_normal_dataset:
            ...
            valid_ds = data.CacheDataset(data=valid_list, transform=pretrain_train_transforms,
                                    cache_num=24, progress=True, cache_rate=1.0, num_workers=args.workers)
